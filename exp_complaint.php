...
$data = mysqli_query($con,"select DATE_ADD(date, INTERVAL 7 DAY) AS exp_date,status,name,subject,file,date,time,description from complaints join users on users.login_id = complaints.login_id ");
